        ...
        <div class="row gy-4">
            <div class="col-lg-4 col-md-6 footer-about">
                ...
                <div class="footer-contact pt-3">
                    ...
                    <p><strong>Email:</strong> <span>gasbygas@gmail.com</span></p>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-3 footer-links">
                ...
                <ul>
                    ...
                    <li><i class="bi bi-chevron-right"></i> <a href="#">Request Gas</a></li>
                    <li><i class="bi bi-chevron-right"></i> <a href="#">Track Delivery</a></li>
                </ul>
            </div>
