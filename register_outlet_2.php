...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user_type == "Outlet") {
        ...
        $sql_main = "INSERT INTO tbl_outlet (outlet_name, outlet_reg, email, contact, add_1, city, district) 
        VALUES ('$outlet_name', '$outlet_reg', '$email', '$contact', '$add_1', '$city', '$district')";
        $sql_log = "INSERT INTO tbl_logs (user_name, access_code, user_type) 
